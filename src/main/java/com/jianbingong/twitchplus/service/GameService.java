...
import com.jianbingong.twitchplus.entity.db.ItemType;
...
import com.jianbingong.twitchplus.entity.response.Game;

import java.util.*;

@Service
public class GameService {
    private static final String TOKEN = "Bearer euuj5vdcgjhe1guvz5fygti4e74hmr";
    private static final String CLIENT_ID = "ubnskr517byd4wfdetm2pfqotf54nz";
    ...
    // Send HTTP request to Twitch Backend based on the given URL, and returns
    // the body of the HTTP response returned from Twitch backend.
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> {
            ...
            //data is returned by the backend of twitch.
